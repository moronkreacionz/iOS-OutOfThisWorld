...
// this is called class methods

+ (NSMutableArray *)allKnownPlanets; // Returns an array of NSDictionaries

+ (NSMutableArray *)otherAstronomicalBodies; // Returns an array of NSDictionaries
